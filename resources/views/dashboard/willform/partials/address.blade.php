<div class="card card-accent-success hide" v-if="step===3">
    ...
    <form id="address_form" name="address_form">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input class="form-control form-control-lg"
                           ...
                           name="postal_code" required data-parsley-trigger="change" data-parsley-pattern="/^([Gg][Ii][Rr] 0[Aa]{2})|((([A-Za-z][0-9]{1,2})|(([A-Za-z][A-Ha-hJ-Yj-y][0-9]{1,2})|(([A-Za-z][0-9][A-Za-z])|([A-Za-z][A-Ha-hJ-Yj-y][0-9]?[A-Za-z])))) [0-9][A-Za-z]{2})$/" />
        ...
        <div class="card-footer">
            <div class="form-group d-flex justify-content-between">
                <button class="btn btn-lg btn-primary" @click="step=2" id="address_back">
