<div class="card card-accent-success hide" v-if="step===4">
            ...
            <div class="row d-flex">
                <div class="form-group col-sm-6 align-self-end">
                    <label class="form-col-form-label h4" for="email_second">What is <span
                            class="second_applicant">@{{ secondApplicant.firstName ? secondApplicant.firstName : 'Second Applicant' }}
                ...
                <div class="form-group col-sm-6 align-self-end">
                    ...
                    <input class="form-control form-control-lg datepicker" id="dob_second" name="dob_second"
                           ...
                           v-model.trim="$v.secondApplicant.dob.$model"
                           :class="$v.secondApplicant.dob.$anyError ? 'is-invalid':''"
