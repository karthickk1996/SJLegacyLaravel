            ...
            <div class="row d-flex">
                ...
                <div class="form-group col-sm-6 align-self-end">
                    <label class="form-col-form-label h4" for="dob_second">What is <span
                        ...
                        @{{ reserveguardian[index].firstName ? reserveguardian[index].firstName : 'Second Applicant' }}'s date of
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group d-flex justify-content-between">
                        <button class="btn btn-lg btn-warning" @click.prevent="AddReserveGuardian"><i class="fa fa-plus-circle"></i>
                            Add Reserve guardian
                        </button>
                        <div v-if="index > 0">
                            <button class="btn btn-lg btn-danger" v-if="reserveGuardian.length > 1" @click.prevent="removeReserveGuardian(index)">
